  ...
  return (
    <AppShell title="Institutional Memory" subtitle="Similar historical macro episodes and what happened next">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        {/* Episode detail — re-animates when selection changes */}
        <div className="lg:col-span-8 space-y-4 animate-fade-in" key={selected.id}>

          {/* Episode header + compare toggle */}
            ...
            <div className="flex items-start justify-between mb-3 flex-wrap gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  title="Toggle Now vs History comparison"
                >
          ...
          {/* 4.5 Compare Now vs History side-by-side panel */}
          {compareMode && (
          ...
          {/* Key indicators (hidden in compare mode) */}
          {!compareMode && (
